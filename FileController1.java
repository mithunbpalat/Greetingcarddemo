...
import com.app.service.FileStorageService1;
...
public class FileController1 {
  ...
  @Autowired
  private FileStorageService1 storageService;
  ...
  @GetMapping("/files1/{id}")
  public ResponseEntity<byte[]> getFile(@PathVariable String id) {
    FileDB1 fileDB = storageService.getFile(id);
  ...
  @DeleteMapping(value="deletefile1")
